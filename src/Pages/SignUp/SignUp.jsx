        ...
        <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
          <form onSubmit={handleSignUp} className="card-body">
            ...
            <div className="form-control mt-6">
              <button disabled={!isCheckBox} type='submit' className="btn btn-primary">Sing up</button>
            </div>
            <p className="px-6 text-sm text-center dark:text-gray-400">Already have an account yet?
              <Link to='/login' rel="noopener noreferrer" href="#" className="hover:underline dark:text-violet-400">Sign in</Link>.
            </p>
