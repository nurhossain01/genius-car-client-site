...
const Teams = () => {
  return (
    <div className='pt-24 pb-36'>
      <div className='text-center pb-12 w-1/3 mx-auto'>
        <p className='text-red-500 font-bold'>Team</p>
        <h2 className='text-3xl font-bold py-4'>Meet Our Team</h2>
        <p>the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
      </div>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10'>
        <div className="p-6 rounded-md shadow-md dark:bg-gray-900 dark:text-gray-50">
          <img src={team1} alt="" className="w-full rounded-md h-72 dark:bg-gray-500" />
          <div className="mt-6 mb-2 text-center">
            <h2 className="text-xl font-semibold tracking-wide">Car Engine Plug</h2>
            <p className="dark:text-gray-100 text-orange-600 font-bold">Engine Expert</p>
        ...
        <div className="p-6 rounded-md shadow-md dark:bg-gray-900 dark:text-gray-50">
          <img src={team2} alt="" className="w-full rounded-md h-72 dark:bg-gray-500" />
          <div className="mt-6 mb-2 text-center">
            <h2 className="text-xl font-semibold tracking-wide">Car Engine Plug</h2>
            <p className="dark:text-gray-100 text-orange-600 font-bold">Engine Expert</p>
            <div className="flex flex-col justify-center pt-6 lg:pt-0">
        ...
        <div className="p-6 rounded-md shadow-md dark:bg-gray-900 dark:text-gray-50">
          <img src={team3} alt="" className="w-full rounded-md h-72 dark:bg-gray-500" />
          <div className="mt-6 mb-2 text-center">
            <h2 className="text-xl font-semibold tracking-wide">Car Engine Plug</h2>
            <p className="dark:text-gray-100 text-orange-600 font-bold">Engine Expert</p>
            <div className="flex flex-col justify-center pt-6 lg:pt-0">
